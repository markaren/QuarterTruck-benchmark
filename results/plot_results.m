...
wheel_cosim_rmse = num2str(sqrt(mean((wheel_ref-wheel_cosim(:,3)).^2)));
wheel_vico_rmse = num2str(sqrt(mean((wheel_ref-wheel_vico(:,3)).^2)));
wheel_fmigo_rmse = num2str(sqrt(mean((wheel_ref-wheel_fmigo).^2)));
wheel_fmpy_rmse = num2str(sqrt(mean((wheel_ref-wheel_fmpy(:,2)).^2)));
wheel_oms_rmse = num2str(sqrt(mean((wheel_ref-wheel_oms).^2)));
