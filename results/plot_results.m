...
wheel_cosim_rmse = num2str(sqrt(mean((wheel_ref_rmse-wheel_cosim(:,3)).^2)));
wheel_vico_rmse = num2str(sqrt(mean((wheel_ref_rmse-wheel_vico(:,3)).^2)));
wheel_fmigo_rmse = num2str(sqrt(mean((wheel_ref_rmse-wheel_fmigo).^2)));
wheel_fmpy_rmse = num2str(sqrt(mean((wheel_ref_rmse-wheel_fmpy(:,2)).^2)));
wheel_oms_rmse = num2str(sqrt(mean((wheel_ref_rmse-wheel_om).^2)));
